...
private ["_group", "_uniformTypes", "_pos", "_leader", "_man2", "_man3", "_man4", "_man5", "_man6", "_man7", "_man8", "_man9", "_man10"];
...
_leader forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
...
_man3 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man3 addVest "V_TacVestIR_blk";
_man3 addMagazine "30Rnd_762x39_Mag_F";
_man3 addWeapon "arifle_AK12_F";
...
_man4 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man4 addVest "V_TacVestIR_blk";
_man4 addMagazine "30Rnd_762x39_Mag_F";
_man4 addWeapon "arifle_AK12_F";
...
_man5 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man5 addVest "V_TacVestIR_blk";
_man5 addMagazine "30Rnd_762x39_Mag_F";
_man5 addWeapon "arifle_AK12_F";
...
_man6 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man6 addVest "V_TacVestIR_blk";
_man6 addMagazine "30Rnd_762x39_Mag_F";
_man6 addWeapon "arifle_AK12_F";
...
_man8 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man8 addVest "V_TacVestIR_blk";
_man8 addMagazine "30Rnd_762x39_Mag_F";
_man8 addWeapon "arifle_AK12_F";
...
_man9 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man9 addVest "V_TacVestIR_blk";
_man9 addMagazine "30Rnd_762x39_Mag_F";
_man9 addWeapon "arifle_AK12_F";
...
_man10 forceAddUniform (_uniformTypes call BIS_fnc_selectRandom);
_man10 addVest "V_TacVestIR_blk";
_man10 addMagazine "30Rnd_762x39_Mag_F";
_man10 addMagazine "1Rnd_HE_Grenade_shell";
_man10 addWeapon "arifle_AK12_GL_F";
