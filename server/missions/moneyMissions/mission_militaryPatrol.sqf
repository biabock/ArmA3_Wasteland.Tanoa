...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy containing at least a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is patrolling Tanoa! Stop the patrol and capture the goods, DRUGS and $50.000!", _vehicleName, _vehicleName2, _vehicleName3, moneyMissionColor];
