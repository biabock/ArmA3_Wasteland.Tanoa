...
} forEach (call compile preprocessFileLineNumbers "mapConfig\convoys\landConvoysList.sqf"); //forEach (call compile preprocessFileLineNumbers "mapConfig\convoys\patrolConvoysList.sqf");