...
switch (_boxType) do
{
	...
	case "airdrop_DLC_LMGs":
	{
		...
		[
			...
			["wep", ["launch_O_Titan_ghex_F", "launch_RPG7_F", "launch_NLAW_F"], RANDOM_BETWEEN(2,5), RANDOM_BETWEEN(1,2)],
			["bac", ["B_Carryall_mcamo", "B_Kitbag_mcamo"], RANDOM_BETWEEN(2,5)],
	...
	case "mission_TOP_Sniper":
	{
		...
		[
			...
			["itm", ["optic_DMS","optic_Nightstalker","optic_SOS"], RANDOM_BETWEEN(1,5)]
		];
	};
		...
		case "apex_bounty":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["launch_O_Titan_ghex_F", "launch_Titan_F", "launch_RPG7_F"], RANDOM_BETWEEN(2,5), RANDOM_BETWEEN(1,3)],
			["wep", "launch_Titan_F", RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(1,2)],
			["itm", "Medikit", RANDOM_BETWEEN(1,4)],
			["itm", "Toolkit", RANDOM_BETWEEN(1,4)],
			["itm", ["optic_Aco", "muzzle_snds_58_wdm_F", "optic_MRCO", "optic_ERCO_blk_F", "optic_Arco"], RANDOM_BETWEEN(2,4)],
			["itm", ["muzzle_snds_M", "muzzle_snds_H", "muzzle_snds_H_MG", "muzzle_snds_B", "muzzle_snds_acp", ["muzzle_snds_338_black", "muzzle_snds_338_green", "muzzle_snds_338_sand"], ["muzzle_snds_93mmg", "muzzle_snds_93mmg_tan"]], RANDOM_BETWEEN(1,5)],
			["itm", ["V_BandollierB_ghex_F", "V_PlateCarrierSpec_tna_F", "V_PlateCarrier2_rgr_noflag_F"], RANDOM_BETWEEN(1,8)],
			["itm", ["B_ViperHarness_blk_F", "U_I_C_Soldier_Para_4_F", "U_B_CTRG_Soldier_urb_1_F"], RANDOM_BETWEEN(1,8)],
			["wep", [["arifle_SPAR_01_snd_F", "arifle_AKM_F", "arifle_SPAR_03_snd_F"], ["LMG_03_F", "arifle_ARX_ghex_F"]], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(2,4)],
			["wep", ["arifle_ARX_blk_F", "arifle_CTAR_GL_blk_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(2,4)],
			["wep", ["arifle_SPAR_01_GL_snd_F", "arifle_CTARS_blk_F"], RANDOM_BETWEEN(0,2), RANDOM_BETWEEN(4,8)],
			["wep", "arifle_SPAR_02_snd_F", RANDOM_BETWEEN(0,2), RANDOM_BETWEEN(3,5)],
			["wep", ["hgun_Pistol_heavy_01_F", "hgun_Pistol_heavy_01_MRD_F", "hgun_Pistol_heavy_02_F", "hgun_Pistol_heavy_02_Yorris_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,8)],
			["mag", "30Rnd_556x45_Stanag", RANDOM_BETWEEN(5,20)],
			["mag", "20Rnd_762x51_Mag", RANDOM_BETWEEN(5,20)],
			["mag", "30Rnd_65x39_caseless_mag_Tracer", RANDOM_BETWEEN(5,10)],
			["mag", "RPG7_F", RANDOM_BETWEEN(5,10)]
		];
	};		
};
